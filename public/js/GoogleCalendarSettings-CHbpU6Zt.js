...
import { _ as __, a as apiClient } from "./index-DXDUp5pC.js";
...
const getGlobalSettings = () => {
  ...
  return {
    connected: gcSettings.connected || false,
    calendar_id: gcSettings.calendar_id || "",
    calendar_name: gcSettings.calendar_name || "",
    client_id: gcSettings.client_id || "",
    client_secret: gcSettings.client_secret || "",
    redirect_uri: gcSettings.redirect_uri || `${yatraAdmin.siteUrl || ""}/wp-json/yatra-pro/v1/google-calendar/callback`,
    last_sync: gcSettings.last_sync || null
  };
};
const GoogleCalendarSettings = () => {
  const [settings, setSettings] = reactExports.useState(getGlobalSettings());
...
//# sourceMappingURL=GoogleCalendarSettings-CHbpU6Zt.js.map
