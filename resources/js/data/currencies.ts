 ...
 */
export const POPULAR_CURRENCIES = ['USD', 'EUR', 'GBP', 'JPY', 'CNY', 'CAD', 'AUD', 'CHF', 'INR', 'NPR'];

export const getPopularCurrencyOptions = (): Array<{ value: string; label: string }> => {
 ...
 */
export const formatCurrency = (amount: number, code: string = 'USD', showCode: boolean = false): string => {
