  ...
  return (
    <div className="yatra-documents-page space-y-6">
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:gap-4">
            ...
            <div className="relative">
              ...
              >
                <option value="all">{__('All Documents', 'All Documents')}</option>
                <option value="itinerary">{__('Itineraries', 'Itineraries')}</option>
                <option value="voucher">{__('Vouchers', 'Vouchers')}</option>
                <option value="invoice">{__('Invoices', 'Invoices')}</option>
      ...
      <div className="yatra-documents-stats flex flex-nowrap gap-6 overflow-x-auto">
        ...
        <div className="flex-shrink-0 yatra-document-stat-card bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-xl p-6 min-w-0 flex-1">
          <div>
            <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">{__('Downloads', 'Downloads')}</p>
                ...
                <div className="flex items-start gap-4">
                  <div className="flex-1 min-w-0">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {doc.category === 'downloads' && (
                          <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                            {__('Access', 'Access')}: <span className="font-medium text-gray-700 dark:text-gray-300">{doc.access_label || doc.access || '-'}</span>
                    ...
                    <div className="yatra-document-actions flex flex-wrap gap-3 mt-4">
                      {doc.locked || !doc.url ? (
                        <div className="inline-flex items-center px-4 py-2 rounded-lg bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-300 transition-colors text-sm font-medium cursor-not-allowed" title={doc.locked_reason || __('Not available', 'Not available')}>
                          {__('Not Available', 'Not Available')}
                        </div>
                      ) : (
                        <a href={doc.url} target="_blank" rel="noreferrer" className="yatra-document-action yatra-document-action-download inline-flex items-center px-4 py-2 rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition-colors text-sm font-medium">
