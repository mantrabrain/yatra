        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
              {__('Update your contact details, address, and communication preferences.', 'yatra')}
            </p>
          </div>
          {!isEditing && (
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="yatra-profile-field">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                {__('Full Name', 'yatra')} <span className="text-red-500">*</span>
              </label>
              {isEditing ? (
                <input
                  type="text"
                ...
                <p className="text-sm font-medium text-gray-900 dark:text-white py-2">{formData.name || __('Not set', 'yatra')}</p>
              )}
            </div>

            <div className="yatra-profile-field">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                {__('Email Address', 'yatra')} <span className="text-red-500">*</span>
              </label>
              {isEditing ? (
                <input
                  type="email"
                ...
                <p className="text-sm font-medium text-gray-900 dark:text-white py-2">{formData.email || __('Not set', 'yatra')}</p>
              )}
            </div>
            ...
            <div className="yatra-profile-field">
              ...
              {isEditing ? (
                ...
                <p className="text-sm font-medium text-gray-900 dark:text-white py-2">{formData.phone || __('Not set', 'yatra')}</p>
              )}
            </div>
            ...
            <div className="yatra-profile-field">
              ...
              {isEditing ? (
                ...
                <p className="text-sm font-medium text-gray-900 dark:text-white py-2">{formData.city || __('Not set', 'yatra')}</p>
              )}
            </div>
            ...
            <div className="yatra-profile-field md:col-span-2">
              ...
              {isEditing ? (
                ...
                <p className="text-sm font-medium text-gray-900 dark:text-white py-2">{formData.address || __('Not set', 'yatra')}</p>
              )}
            </div>
            ...
            <div className="yatra-profile-field">
              ...
              {isEditing ? (
                ...
                <p className="text-sm font-medium text-gray-900 dark:text-white py-2">{formData.country || __('Not set', 'yatra')}</p>
              )}
            </div>
          </div>
        ...
        {isChangingPassword && (
          <div className="space-y-4">
            <div className="yatra-password-field">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                {__('Current Password', 'yatra')} <span className="text-red-500">*</span>
              </label>
              <input
                type="password"
            ...
            <div className="yatra-password-field">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                {__('New Password', 'yatra')} <span className="text-red-500">*</span>
              </label>
              <input
                type="password"
            ...
            <div className="yatra-password-field">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                {__('Confirm New Password', 'yatra')} <span className="text-red-500">*</span>
              </label>
              <input
                type="password"
              ...
              {passwordData.newPassword && passwordData.confirmPassword && passwordData.newPassword !== passwordData.confirmPassword && (
                <p className="text-xs text-red-500 mt-1">{__('Passwords do not match', 'yatra')}</p>
              )}
            </div>
        ...
        <div className="yatra-profile-communication bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-xl shadow-sm p-6">
          ...
          <div className="yatra-profile-preferences space-y-3 text-sm">
            <label className="flex items-center gap-3 cursor-pointer">
              ...
              <span className="text-gray-700 dark:text-gray-300">{__('Booking reminders', 'yatra')}</span>
            </label>
            <label className="flex items-center gap-3 cursor-pointer">
              <input type="checkbox" defaultChecked className="w-4 h-4 rounded text-blue-600 focus:ring-blue-500" />
              <span className="text-gray-700 dark:text-gray-300">{__('Payment notifications', 'yatra')}</span>
            </label>
            <label className="flex items-center gap-3 cursor-pointer">
              <input type="checkbox" className="w-4 h-4 rounded text-blue-600 focus:ring-blue-500" />
              <span className="text-gray-700 dark:text-gray-300">{__('Promotional offers', 'yatra')}</span>
            </label>
            <label className="flex items-center gap-3 cursor-pointer">
              <input type="checkbox" defaultChecked className="w-4 h-4 rounded text-blue-600 focus:ring-blue-500" />
              <span className="text-gray-700 dark:text-gray-300">{__('Trip updates', 'yatra')}</span>
            </label>
          </div>
        </div>
          ...
          <div className="yatra-saved-trips-list space-y-3">
            {savedTrips.length > 0 ? (
              savedTrips.map((trip: any) => (
                <div key={trip.id || trip.trip_id} className="yatra-saved-trip-item flex items-center justify-between border border-gray-100 dark:border-gray-700 rounded-lg p-4 hover:bg-gray-50 dark:hover:bg-gray-900/40 transition-colors">
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-gray-900 dark:text-white truncate">{trip.trip_title || trip.title}</p>
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">{formatDate(trip.next_departure)}</p>
                  </div>
                  <div className="text-right ml-4 flex-shrink-0">
                    <p className="text-xs text-gray-500 dark:text-gray-400">{__('From', 'yatra')}</p>
                    <p className="text-sm font-semibold text-gray-900 dark:text-white">{currency(trip.price_from || trip.price || 0)}</p>
                  </div>
                </div>
              ))
            ) : (
              <p className="text-sm text-gray-500 dark:text-gray-400 text-center py-4">{__('No saved trips yet', 'yatra')}</p>
            )}
          </div>
        </div>
      </div>
