...
const AdditionalServicesPremium: React.FC = () => {
  const features = [
    {
      ...
      description: __('Create and manage unlimited add-on services for your trips.')
    },
    {
      icon: DollarSign,
      title: __('Flexible Pricing'),
      description: __('Set pricing per person, per booking, or per day with multiple options.')
    },
    {
      icon: Users,
      title: __('Trip Assignment'),
      description: __('Assign services to specific trips or apply globally to all trips.')
    },
    {
      icon: Shield,
      title: __('Booking Integration'),
      description: __('Seamless integration with booking process and payment collection.')
    }
  ];
  ...
  const popularServices = [
    ...
    },
    {
      ...
      description: __('Delicious meal options for different dietary requirements.'),
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-amber-700 dark:text-amber-300 text-sm">
                {__('Additional Services is a premium module. Upgrade to Yatra Pro to unlock all features.')}
              </p>
            </div>
          </div>
          <Button 
        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="mb-6 md:mb-0 md:pr-8">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              {__('Offer premium add-ons and boost your revenue with Yatra Pro.')}
            </p>
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-green-500" />
                <span className="text-sm text-gray-600 dark:text-gray-400">{__('Airport transfers')}</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-green-500" />
                <span className="text-sm text-gray-600 dark:text-gray-400">{__('Travel insurance')}</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-green-500" />
                <span className="text-sm text-gray-600 dark:text-gray-400">{__('Equipment rental')}</span>
              </div>
            </div>
          </div>
