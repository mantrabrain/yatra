    ...
    return (
      <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-6">
        ...
        <p className="text-red-600 dark:text-red-400 mt-2">
          {__(
            "Missing or invalid departure ID or trip ID in the URL.",
            "yatra",
          )}
        </p>
      </div>
      ...
      <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-6">
        ...
        <p className="text-red-600 dark:text-red-400 mt-2">
          {(error as any)?.message ||
            __("Unable to load departure details.", "yatra")}
        </p>
      </div>
    );
  }
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div>
              ...
              <CardDescription>
                ...
                {departure.time &&
                  ` ${__("at", "yatra")} ${formatTime(departure.time)}`}
              </CardDescription>
            </div>
            ...
            {tabs.map((tab) => (
              ...
              >
                <span className="flex items-center">
                  {React.createElement(
                    SVGIcons[tab.icon as keyof typeof SVGIcons],
                  )}
                </span>
              ...
              {departure.booking_ids && departure.booking_ids.length > 0 ? (
                ...
                <div className="text-center py-12 bg-gray-50 dark:bg-gray-800 rounded-lg">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mt-2">
                    {__(
                      "This departure doesn't have any linked bookings.",
                      "yatra",
                    )}
                  </p>
                </div>
            ...
            <div className="space-y-4">
              ...
              {departure.travelers && departure.travelers.length > 0 ? (
                      ...
                      <div className="flex justify-between items-start">
                        <div>
                          <h4 className="font-medium text-gray-900 dark:text-white">
                            ...
                            {traveler.is_lead && (
                              <span className="ml-2 px-2 py-1 bg-blue-100 dark:bg-blue-900/20 text-blue-800 dark:text-blue-400 text-xs rounded">
                                {__("Lead", "yatra")}
                              </span>
                            )}
                          </h4>
                ...
                <div className="text-center py-12 bg-gray-50 dark:bg-gray-800 rounded-lg">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mt-2">
                    {__(
                      "No travelers have been assigned to this departure.",
                      "yatra",
                    )}
                  </p>
                </div>
              ...
              {departure.price_override && (
                <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
                  ...
                  <p className="text-yellow-700 dark:text-yellow-400 text-sm mt-1">
                    {__("This departure has a custom price of", "yatra")}{" "}
                    {formatCurrency(departure.price_override)}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      <span className="text-gray-600 dark:text-gray-400">
                        {__("Current Status", "yatra")}:
                      </span>
                      <span
                        className={`px-2 py-1 rounded text-sm font-medium ${getStatusStyle(departure.status || "upcoming")}`}
                      >
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-gray-900 dark:text-white">
                        {departure.updated_at
                          ? formatDate(departure.updated_at)
                          : "--"}
                      </span>
                    </div>
                    <div className="flex justify-between">
                ...
                <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      <span className="text-gray-600 dark:text-gray-400">
                        {__("Revenue per Seat", "yatra")}:
                      </span>
                      <span className="font-medium text-gray-900 dark:text-white">
                        {formatCurrency(
                          (departure.total_revenue || 0) /
                            Math.max(maxCapacity, 1),
                        )}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600 dark:text-gray-400">
                        {__("Utilization Rate", "yatra")}:
                      </span>
                      <span className="font-medium text-gray-900 dark:text-white">
                        {occupancyRate.toFixed(1)}%
                      </span>
