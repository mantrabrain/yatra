...
interface AvailabilityDate {
  ...
  /** True for read-only dates generated by a recurring rule */
  is_virtual?: boolean;
  status:
    | "available"
    | "sold_out"
                            ...
                            >
                              <div className="space-y-3">
                                ...
                                {availability.is_virtual && (
                                  <div className="mb-2 inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-medium bg-indigo-50 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-300">
                                    {__("From rule", "yatra")}
                                  </div>
                                )}
