  ...
  const dialogContent = (
    <div className="fixed top-0 left-0 right-0 bottom-0 m-0 bg-black/60 backdrop-blur-sm z-[9999] flex items-center justify-center px-4 pb-4">
      <div className="relative w-full max-w-5xl">
        {/* Subtle premium glow */}
        <div className="absolute -inset-0.5 bg-gradient-to-r from-amber-500/20 via-yellow-500/20 to-amber-500/20 rounded-2xl blur-2xl"></div>
        
        <Card className="relative w-full shadow-2xl border border-amber-200/80 dark:border-amber-700/50 bg-white dark:bg-slate-900 overflow-hidden max-h-[90vh] flex flex-col">
          {/* Premium accent bar */}
          <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-amber-500 via-yellow-500 to-amber-500"></div>
          
          <CardHeader className="relative pb-4 pt-6 border-b border-gray-200 dark:border-gray-800 flex-shrink-0 bg-gradient-to-b from-amber-50/30 to-transparent dark:from-amber-950/20">
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-3">
                <div className="relative">
                  <div className="absolute inset-0 bg-amber-400 rounded-lg blur-md opacity-40"></div>
                  <div className="relative p-2.5 rounded-lg bg-gradient-to-br from-amber-500 to-yellow-500 shadow-md">
          ...
          <CardContent className="relative flex-1 overflow-hidden pt-6 px-6 pb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:justify-end pt-6 mt-6 border-t border-gray-200 dark:border-gray-800 flex-shrink-0">
              ...
              <Button
                className="bg-gradient-to-r from-amber-500 to-yellow-500 hover:from-amber-600 hover:to-yellow-600 text-white font-semibold shadow-md hover:shadow-lg transition-all duration-200 flex items-center gap-2 group"
                onClick={() => {
                  if (purchaseUrl) {
