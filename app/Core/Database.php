...
class Database
{
    ...
    public static function createTables(): void
    {
        ...
        // Attributes table - stores attribute definitions
        ...
        ) {$charset_collate} COMMENT='Trip attribute definitions and field configurations';";

        \dbDelta($sql_attributes);
        
        // Trip Attributes table - stores trip-specific attribute values
        $table_trip_attributes = $wpdb->prefix . 'yatra_trip_attributes';
        
        $sql_trip_attributes = "CREATE TABLE IF NOT EXISTS `{$table_trip_attributes}` (
            `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
            ...
            FOREIGN KEY (`attribute_id`) REFERENCES `{$table_attributes}` (`id`) ON DELETE CASCADE
        ) {$charset_collate} COMMENT='Trip-specific attribute values';";

        \dbDelta($sql_trip_attributes);
