...
class Yatra_Settings_Emails extends Yatra_Admin_Settings_Base
{
    ...
    public function __construct()
    {
        ...
        $this->description = __('Manage email notifications, templates, and email settings', 'yatra');
        $this->icon = '<svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor"><path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0 0 16 4H4a2 2 0 0 0-1.997 1.884z"/><path d="M18 8.118l-8 4-8-4V14a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8.118z"/></svg>';
