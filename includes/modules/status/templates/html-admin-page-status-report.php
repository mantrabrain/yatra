...
<div class="updated yatra-message inline">
    <p>
        <?php esc_html_e('Please copy and paste this information in your ticket when contacting support:', 'yatra'); ?>
    </p>
    <p class="submit">
        <a href="#" class="button-primary debug-report"><?php esc_html_e('Get system report', 'yatra'); ?></a>
        <a class="button-secondary docs"
           href="https://docs.yatra.com/document/understanding-the-yatra-system-status-report/"
           target="_blank">
            <?php esc_html_e('Understanding the status report', 'yatra'); ?>
        </a>
    </p>
    <div id="debug-report">
        ...
        <p class="submit">
            <button id="copy-for-support" class="button-primary" href="#"
                    data-tip="<?php esc_attr_e('Copied!', 'yatra'); ?>">
                <?php esc_html_e('Copy for support', 'yatra'); ?>
            </button>
        </p>
        <p class="copy-error hidden">
            <?php esc_html_e('Copying to clipboard failed. Please press Ctrl/Cmd+C to copy.', 'yatra'); ?>
        </p>
    </div>
</div>
...
<table class="yatra_status_table widefat" cellspacing="0">
    ...
    if ($environment['mysql_version']) :
        ...
        <tr>
            ...
            <td class="help"><?php echo(esc_html__('The version of MySQL installed on your hosting server.', 'yatra')); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></td>
            <td>
                <?php
    ...
    <tr>
        ...
        <td class="help"><?php echo(esc_html__('The largest filesize that can be uploaded to your WordPress installation.', 'yatra')); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></td>
    ...
    <tr>
        ...
        <td class="help"><?php echo(esc_html__('The default timezone for your server.', 'yatra')); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></td>
        <td>
            <?php
    ...
    <tr>
        ...
        <td class="help"><?php echo(esc_html__('Payment gateways can use cURL to communicate with remote servers to authorize payments, other plugins may also use it when communicating with remote services.', 'yatra')); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></td>
        <td>
            <?php
    ...
    <tr>
        ...
        <td class="help"><?php echo(esc_html__('Some webservices like shipping use SOAP to get information from remote servers, for example, live shipping quotes from FedEx require SOAP to be installed.', 'yatra')); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></td>
        <td>
            <?php
    ...
    <tr>
        ...
        <td class="help"><?php echo(esc_html__('HTML/Multipart emails use DOMDocument to generate inline CSS in templates.', 'yatra')); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></td>
        <td>
            <?php
    ...
    <tr>
        ...
        <td class="help"><?php echo(esc_html__('GZip (gzopen) is used to open the GEOIP database from MaxMind.', 'yatra')); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></td>
        <td>
            <?php
    ...
    <tr>
        ...
        <td class="help"><?php echo(esc_html__('Multibyte String (mbstring) is used to convert character encoding, like for emails or converting characters to lowercase.', 'yatra')); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></td>
        <td>
            <?php
    ...
    <tr>
        ...
        <td class="help"><?php echo(esc_html__('PayPal uses this method of communicating when sending back transaction information.', 'yatra')); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></td>
        <td>
            <?php
    ...
    <tr>
        ...
        <td class="help"><?php echo(esc_html__('WooCommerce plugins may use this method of communication when checking for plugin updates.', 'yatra')); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></td>
        <td>
            <?php
...
<table id="status-database" class="yatra_status_table widefat" cellspacing="0">
    ...
    <tr>
        ...
        <td class="help"><?php echo(esc_html__('The database version for WooCommerce. Note that it may not match WooCommerce core version and that is normal.', 'yatra')); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></td>
...
<table class="yatra_status_table widefat" cellspacing="0">
    ...
    <tr>
        ...
        <td class="help"><?php echo(esc_html__('Is the connection to your store secure?', 'yatra')); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></td>
        <td>
    ...
    <tr>
        ...
        <td class="help"><?php echo(esc_html__('Error messages can contain sensitive information about your store environment. These should be hidden from untrusted visitors.', 'yatra')); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></td>
        <td>
...
<table class="yatra_status_table widefat" cellspacing="0">
    ...
    <tr>
        ...
        <td class="help"><?php echo(esc_html__('Does your site have REST API enabled?', 'yatra')); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></td>
    ...
    <tr>
        ...
        <td class="help"><?php echo(esc_html__('Does your site force a SSL Certificate for transactions?', 'yatra')); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></td>
    ...
    <tr>
        ...
        <td class="help"><?php echo(esc_html__('What currency prices are listed at in the catalog and which currency gateways will take payments in.', 'yatra')); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></td>
    ...
    <tr>
        ...
        <td class="help"><?php echo(esc_html__('The position of the currency symbol.', 'yatra')); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></td>
    ...
    <tr>
        ...
        <td class="help"><?php echo(esc_html__('The thousand separator of displayed prices.', 'yatra')); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></td>
    ...
    <tr>
        ...
        <td class="help"><?php echo(esc_html__('The decimal separator of displayed prices.', 'yatra')); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></td>
    ...
    <tr>
        ...
        <td class="help"><?php echo(esc_html__('The number of decimal points shown in displayed prices.', 'yatra')); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></td>
        <td><?php echo esc_html($settings['number_of_decimals']); ?></td>
    </tr>
    <tr>
        <td data-export-label="Taxonomies: Product Types">
        <?php esc_html_e('Taxonomies: Product types', 'yatra'); ?></th>
        <td class="help"><?php echo(esc_html__('A list of taxonomy terms that can be used in regard to order/product statuses.', 'yatra')); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></td>
        <td>
            <?php
            $display_terms = array();
    ...
    <tr>
        <td data-export-label="Taxonomies: Product Visibility">
        <?php esc_html_e('Taxonomies: Product visibility', 'yatra'); ?></th>
        <td class="help"><?php echo(esc_html__('A list of taxonomy terms used for product visibility.', 'yatra')); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></td>
        <td>
            <?php
            $display_terms = array();
...
<table class="yatra_status_table widefat" cellspacing="0">
    <thead>
    <tr>
        <th colspan="3" data-export-label="WC Pages"><h2><?php esc_html_e('WooCommerce pages', 'yatra'); ?></h2>
        </th>
    </tr>
    </thead>
    <tbody>
...
<table class="yatra_status_table widefat" cellspacing="0">
    ...
    <tr>
        <th colspan="3" data-export-label="Templates">
            <h2><?php esc_html_e('Templates', 'yatra'); ?><?php echo(esc_html__('This section shows any files that are overriding the default WooCommerce template pages.', 'yatra')); ?></h2>
        </th>
    </tr>
    </thead>
    <tbody>
...
<table class="yatra_status_table widefat" cellspacing="0">
    ...
    <tr>
        <th colspan="3" data-export-label="Status report information">
            <h2><?php esc_html_e('Status report information', 'yatra'); ?><?php echo(esc_html__('This section shows information about this status report.', 'yatra')); ?></h2>
        </th>
    </tr>
    </thead>
    <tbody>
