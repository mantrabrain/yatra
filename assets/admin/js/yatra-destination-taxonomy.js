var YatraDestinationTaxonomy = function ($) {
    return {
        ...
        initMediaUploader: function (uploadBtn, wrapper) {
            ...
            var $this = this;
            if (this.taxonomy_destination_media_frame) this.taxonomy_destination_media_frame.close();

            this.taxonomy_destination_media_frame = wp.media.frames.file_frame = wp.media({
            ...
            this.taxonomy_destination_media_frame.on('select', function () {

                var attachment = $this.taxonomy_destination_media_frame.state().get('selection').first().toJSON();
                ...
                var selection = $this.taxonomy_destination_media_frame.state().get('selection');

            });


            this.taxonomy_destination_media_frame.open();
        },
