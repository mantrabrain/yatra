import { r as reactExports, j as jsxRuntimeExports, D as Loader2, S as Sparkles, aB as Wand2, bD as Pencil, bi as Scissors, bE as Maximize2, bh as Heart, ax as X, aA as Check, Q as AlertTriangle, az as AlertCircle, aQ as Eye, aE as HelpCircle, J as RefreshCw, ar as Clock, aD as CheckCircle2, u as useQuery, e as Tag, aw as Plus, bc as ChevronUp, x as ChevronDown, p as Calendar, V as ExternalLink, a5 as React, bF as CheckSquare, I as User, q as MapPin, n as Star, t as useQueryClient, k as FileText, as as DollarSign, bG as BookOpen, aS as Image, b6 as Download, aO as Search, l as Settings, v as useMutation, aG as Copy, bH as Lightbulb, b2 as Database, bI as History, aV as Save, bj as Send, aC as ChevronLeft, y as ChevronRight, bJ as Box, m as BarChart3, aN as Trash2, bb as GripVertical, aR as Upload, U as Users, bK as Home, bL as Car } from "./react-vendor-xzSqHjRF.js";
import { i as isAiEligible, a as isAiModuleEnabled, b as isAiReady, c as aiApi, M as Modal, B as Button, p as parseItineraryText, C as Card, d as CardContent, e as Badge, T as TimePicker, S as Select, f as CardHeader, g as CardTitle, h as CardDescription, u as usePermissions, j as getErrorContext, A as Alert, H as HelpText, k as ConfirmationDialog, l as buildYatraSinglePublicUrls, m as isWordPressPlainPermalink, D as DatePicker, I as IconPicker, L as LocationPicker, R as RichTextEditor, n as prepareWordPressMediaFrameOpen, o as fetchSettings } from "../../admin/dist/js/app.js";
import { _ as __$1, I as Input, a as apiClient, b as apiService, u as useToast, w as wpService, h as getCurrencySymbol, s as sprintf } from "./index-d5SvbCd2.js";
import { d as detectClarification, B as BuildItineraryModal } from "./BuildItineraryModal-uwHaNgQi.js";
import { P as ProBadge, M as MultiSelect, a as ProFeature } from "./ProFeature-xUch0Nzh.js";
    ...
    mutationFn: async (data) => {
      const payload = {
        ...
        price_types: data.pricing_type === "traveler_based" ? data.price_types.map((pt) => ({
          ...
          is_default: Boolean(pt.is_default),
          original_price: pt.original_price ? parseFloat(pt.original_price) : null,
...
//# sourceMappingURL=TripForm-CNo9Rmha.js.map
