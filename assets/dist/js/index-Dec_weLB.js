import { a1 as getDefaultExportFromCjs, r as reactExports, j as jsxRuntimeExports, a6 as React, ay as X, aG as Info, V as AlertTriangle, aA as AlertCircle, aE as CheckCircle2, y as ChevronDown, az as reactDomExports, aP as Search } from "./react-vendor-CithbthY.js";
...
const ToastContainer = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: toasts.map((toast) => /* @__PURE__ */ jsxRuntimeExports.jsx(ToastItem, { toast, onRemove }, toast.id))
    }
  );
};
...
const API_ENDPOINTS = {
  ...
  TRIP_AVAILABLE_DATES: (id) => `/trips/${id}/available-dates`,
  // Departures
  ...
  SCHEDULED_PAYMENT_CANCEL: (id) => `/scheduled-payments/${id}/cancel`,
  SCHEDULED_PAYMENTS_OUTSTANDING: "/scheduled-payments/outstanding",
  SCHEDULED_PAYMENT_SEND_LINK: (bookingId) => `/scheduled-payments/outstanding/${bookingId}/send-link`,
  // Reports
  REPORTS: "/reports",
  ...
  EMAIL_TEMPLATE_OVERRIDE: (id) => `/email-templates/${id}/override`,
...
const apiService = {
  ...
  getTripAvailableDates: (id) => apiClient.get(API_ENDPOINTS.TRIP_AVAILABLE_DATES(id)),
  ...
  createCustomer: (data) => apiClient.post(API_ENDPOINTS.CUSTOMERS, data),
  ...
  getBookingFormConfig: (tripId) => apiClient.get(API_ENDPOINTS.SETTINGS_BOOKING_FORM, {
    params: tripId ? { trip_id: tripId } : void 0
  }),
  // Notices
  ...
  getScheduledPayments: (params) => apiClient.get(API_ENDPOINTS.SCHEDULED_PAYMENTS, { params }),
  getScheduledPaymentsStats: () => apiClient.get(API_ENDPOINTS.SCHEDULED_PAYMENTS_STATS),
  cancelScheduledPayment: (id) => apiClient.post(API_ENDPOINTS.SCHEDULED_PAYMENT_CANCEL(id), {}),
  getOutstandingBalances: (params) => apiClient.get(API_ENDPOINTS.SCHEDULED_PAYMENTS_OUTSTANDING, { params }),
  sendBalancePaymentLink: (bookingId) => apiClient.post(API_ENDPOINTS.SCHEDULED_PAYMENT_SEND_LINK(bookingId), {}),
  // Google Calendar
   ...
   */
  resyncGoogleCalendar: (cursor = 0, limit = 25) => apiClient.post(API_ENDPOINTS.GOOGLE_CALENDAR_RESYNC, { cursor, limit }),
...
function getDateFormat() {
  var _a, _b, _c;
  const w = window;
  return ((_a = w == null ? void 0 : w.yatraAdmin) == null ? void 0 : _a.date_format) || ((_b = w == null ? void 0 : w.yatraAdmin) == null ? void 0 : _b.dateFormat) || // Customer account pages localize their settings under yatraAccountPage.
  ((_c = w == null ? void 0 : w.yatraAccountPage) == null ? void 0 : _c.date_format) || "Y-m-d";
}
function getTimeFormat() {
  var _a, _b, _c;
  const w = window;
  return ((_a = w == null ? void 0 : w.yatraAdmin) == null ? void 0 : _a.time_format) || ((_b = w == null ? void 0 : w.yatraAdmin) == null ? void 0 : _b.timeFormat) || ((_c = w == null ? void 0 : w.yatraAccountPage) == null ? void 0 : _c.time_format) || "H:i";
}
function toDateValue(value) {
  if (value === null || value === void 0) return /* @__PURE__ */ new Date(NaN);
  if (value instanceof Date) return value;
  if (typeof value !== "string") return /* @__PURE__ */ new Date(NaN);
...
function formatDatePart(date, phpFormat) {
...
function formatTimePart(date, phpFormat) {
...
function todayYmd() {
  return formatDateForInput(/* @__PURE__ */ new Date());
}
  ...
  const pickNumber = (...fields) => {
    for (const o of sources) {
      ...
      for (const field of fields) {
        const v = o[field];
        if (v !== void 0 && v !== null && v !== "" && !Number.isNaN(Number(v))) {
          return Number(v);
        }
      }
    }
...
function formatYatraMoney(amount, currencyCode, options) {
  ...
  const { decimalPlaces, thousandSeparator, decimalSeparator } = readYatraNumberFormatConfig();
                    ...
                    "span",
                    {
                      ...
                      children: selectedOption ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between w-full", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2 min-w-0", children: [
                          selectedOption.icon && /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "img",
                            {
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: selectedOption.label })
                        ] }),
...
function getCountryMap() {
  var _a, _b;
  const w = window;
  const sources = [(_a = w == null ? void 0 : w.yatraAdmin) == null ? void 0 : _a.countries, (_b = w == null ? void 0 : w.yatraAccountPage) == null ? void 0 : _b.countries];
...
function getCountrySelectOptions() {
  var _a;
  const base = ((_a = window.yatraAdmin) == null ? void 0 : _a.flagBase) || "";
  return getCountryOptions().map((c) => ({
    value: c.code,
    label: c.name,
    icon: base ? base + c.code.toLowerCase() + ".svg" : void 0
  }));
}
...
class ErrorBoundary extends React.Component {
  ...
  render() {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center min-h-[50vh] p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold text-gray-900 dark:text-white mb-2", children: __("Something went wrong", "yatra") }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600 dark:text-gray-400 mb-5", children: __(
...
export {
  ...
  getCountryName as i,
  ajaxService as j,
  applyCurrencyPosition as k,
  getCountrySelectOptions as l,
  getCurrencyOptions as m,
...
//# sourceMappingURL=index-Dec_weLB.js.map
