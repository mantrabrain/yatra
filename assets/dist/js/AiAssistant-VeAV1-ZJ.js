import { t as useQueryClient, r as reactExports, u as useQuery, v as useMutation, j as jsxRuntimeExports, D as Loader2, bQ as KeyRound, S as Sparkles, bA as Pencil, m as BarChart3, V as ExternalLink, aF as Info, bO as Plug, aD as CheckCircle2, b6 as XCircle, bt as EyeOff, aQ as Eye, aV as Save, aN as Trash2, b8 as Lock, M as MessageCircle, R as RotateCcw, Q as AlertTriangle, ba as ChevronUp, x as ChevronDown, C as Crown } from "./react-vendor-CqkbFEvK.js";
import { u as useToast, _ as __ } from "./index-fqW8jODk.js";
...
const AiAssistant = () => {
  ...
  const renderUsage = () => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: !usage ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Loader2, { className: "h-5 w-5 animate-spin text-gray-400" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 grid grid-cols-3 gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: __("Total calls", "yatra"), value: usage.totals.calls.toLocaleString() }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Stat,
            {
  ...
  const renderPrompts = () => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: promptsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Loader2, { className: "h-5 w-5 animate-spin text-gray-400" }) }) : rows.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500", children: __("No prompts available.", "yatra") }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
...
//# sourceMappingURL=AiAssistant-VeAV1-ZJ.js.map
