import { j as jsxRuntimeExports, a6 as React, w as useMutation, d as Mail, y as ChevronDown, r as reactExports, u as useQuery, D as ArrowLeft, q as Calendar, U as Users, aZ as Phone, aA as AlertCircle, k as FileText, i as CreditCard, F as FileSignature, aw as CheckCircle, as as Clock, bk as Send } from "./react-vendor-Dl45l0PD.js";
import { u as useToast, _ as __, a as apiClient, i as getCountryName, e as formatDate, f as formatYatraMoney, b as apiService } from "./index-0YqMQ0Gb.js";
import { aa as Popover, ab as PopoverTrigger, B as Button, ac as PopoverContent, u as usePermissions, N as Skeleton, C as Card, f as CardHeader, d as CardContent, P as PageHeader, r as ConditionalRender, g as CardTitle } from "../../admin/dist/js/app.js";
function phoneData() {
            ...
            (() => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-3 pt-1 border-t border-gray-100 dark:border-gray-700", children: [
                ...
                extras.map(([fieldId, value]) => {
                  ...
                  const display = (field == null ? void 0 : field.type) === "country" ? getCountryName(String(value)) : String(value);
...
//# sourceMappingURL=ViewBooking-y8Yi0hz5.js.map
