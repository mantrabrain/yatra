import { a6 as React, a4 as isFunction, ap as Animate, ao as isEqual, r as reactExports, c8 as Target, q as Calendar, U as Users, bq as BarChart, T as TrendingUp, at as DollarSign, as as Clock, Z as Zap, j as jsxRuntimeExports, S as Sparkles, au as ArrowRight, A as Activity, aw as CheckCircle, v as useQueryClient, u as useQuery, w as useMutation, l as Settings, ax as Plus, aA as AlertCircle, h as Package, aK as PenSquare, aB as Check, aO as Trash2, aW as Save } from "./react-vendor-CithbthY.js";
import { ak as clsx, al as Dot, am as findAllByType, an as ErrorBar, ao as Layer, ap as filterProps, aq as Curve, ar as interpolateNumber, as as isNil, at as hasClipDot, au as LabelList, av as getValueByDataKey, aw as uniqueId, ax as Global, ay as getCateCoordinateOfLine, az as generateCategoricalChart, aA as XAxis, aB as YAxis, aC as formatAxisMap, B as Button, C as Card, d as CardContent, P as PageHeader, af as SearchFilterToolbar, a6 as BulkActionToolbar, f as CardHeader, g as CardTitle, h as CardDescription, Y as Table, e as Badge, aD as ResponsiveContainer, aE as CartesianGrid, aF as Tooltip, k as ConfirmationDialog } from "../../admin/dist/js/app.js";
import { R as RuleTypeSelectionModal } from "./RuleTypeSelectionModal-_WAr6JyA.js";
import { T as Toggle } from "./toggle-CKa3ExrH.js";
import { _ as __, u as useToast, t as toDateValue, a as apiClient, f as formatYatraMoney } from "./index-Dec_weLB.js";
...
const DynamicPricingPage = () => {
  ...
  if (!moduleAvailable) return /* @__PURE__ */ jsxRuntimeExports.jsx(DynamicPricingPremium, {});
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    XAxis,
                    {
                      dataKey: "day",
                      tick: { fontSize: 12 },
                      tickFormatter: (v) => v ? toDateValue(String(v)).toLocaleDateString() : ""
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    YAxis,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-h-[420px] overflow-y-auto rounded-lg border border-gray-200 dark:border-gray-700", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full table-fixed border-collapse text-sm", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: trendData.map((row) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "tr",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 px-4 text-gray-900 dark:text-white", children: row.day ? toDateValue(
                      String(row.day)
                    ).toLocaleDateString() : "" }),
...
//# sourceMappingURL=DynamicPricing-CBtPFtKK.js.map
