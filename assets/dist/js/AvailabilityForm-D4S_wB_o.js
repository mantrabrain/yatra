import { j as jsxRuntimeExports, v as useQueryClient, r as reactExports, u as useQuery, w as useMutation, aA as AlertCircle, D as ArrowLeft, s as MapPin, aE as CheckCircle2, E as Loader2, ax as Plus, ay as X, aW as Save } from "./react-vendor-CithbthY.js";
import { C as Card, f as CardHeader, d as CardContent, A as Alert, P as PageHeader, B as Button, g as CardTitle, h as CardDescription, D as DatePicker, T as TimePicker, H as HelpText, L as LocationPicker, S as Select, a8 as useNavigate } from "../../admin/dist/js/app.js";
import { u as useToast, _ as __, t as toDateValue, I as Input, s as sprintf, a as apiClient } from "./index-Dec_weLB.js";
...
const AvailabilityForm = () => {
  ...
  const availabilityId = urlParams.get("action") === "create" ? null : urlParams.get("id") || null;
  ...
  const isSingleDayTrip = (tripData == null ? void 0 : tripData.trip_type) === "single_day";
  const hasTimeSlots = isSingleDayTrip && !!(tripData == null ? void 0 : tripData.has_default_time_slots);
  const tripMaxTravelers = (() => {
    const raw = Number((tripData == null ? void 0 : tripData.max_travelers) ?? 0);
  ...
  reactExports.useEffect(() => {
    if (tripData && !isEditMode) {
      ...
      setFormData((prev) => ({
        ...
        total_seats: prev.total_seats || (tripMaxTravelers > 0 ? String(tripMaxTravelers) : prev.total_seats),
  ...
  const saveMutation = useMutation({
    mutationFn: async (data) => {
      ...
      const payload = {
        ...
        special_notes: null,
        cutoff_hours: 24,
        alert_threshold: data.alert_threshold ? parseInt(data.alert_threshold) : null,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5", children: [
                    ...
                    " ",
                    hasTimeSlots ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-red-500", children: "*" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-400 font-normal", children: __("(optional)", "yatra") })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    TimePicker,
                    {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5", children: [
                    ...
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-400 font-normal", children: __("(optional)", "yatra") })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    TimePicker,
                    {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  HelpText,
                  {
                    text: tripMaxTravelers > 0 ? sprintf(
...
//# sourceMappingURL=AvailabilityForm-D4S_wB_o.js.map
