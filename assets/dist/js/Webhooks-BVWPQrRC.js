import { r as reactExports, u as useQuery, j as jsxRuntimeExports, x as Webhook, as as Clock, V as AlertTriangle, C as Crown, aE as CheckCircle2, X as ExternalLink, v as useQueryClient, w as useMutation, ax as Plus, bF as Pencil, bk as Send, O as RefreshCw, bD as ShieldCheck, aO as Trash2, b9 as XCircle, Z as Zap, bl as Filter, a6 as React, aR as Eye, R as RotateCcw, E as Loader2, y as ChevronDown, aB as Check, aH as Copy } from "./react-vendor-BJn7BIDO.js";
import { a as apiClient, _ as __, u as useToast, s as sprintf, I as Input } from "./index-CH-UeeqR.js";
import { P as PageHeader, C as Card, d as CardContent, f as CardHeader, g as CardTitle, h as CardDescription, B as Button, Y as Table, e as Badge, k as ConfirmationDialog, S as Select, _ as Pagination, Z as Tooltip, s as Label, $ as Switch, M as Modal, A as Alert } from "../../admin/dist/js/app.js";
import { M as ModulePageSkeleton } from "./module-skeleton-_pm14M7g.js";
const webhooksApi = {
  ...
  getEventSample: (key) => apiClient.get(
  ...
  startListen: (key) => apiClient.post(
    `/webhooks/events/${encodeURIComponent(key)}/listen`,
    {}
  ),
  getListenStatus: (key) => apiClient.get(
    `/webhooks/events/${encodeURIComponent(key)}/listen`
  ),
  ...
  regenerateSecret: (id) => apiClient.post(
...
const EndpointsTab = () => {
  ...
  const [mtlsEndpoint, setMtlsEndpoint] = reactExports.useState(
    null
  );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-4", children: [
      ...
      !sendAll && hasSample && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 pt-2 border-t border-gray-200 dark:border-gray-700", children: [
        ...
        isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-2 max-h-96 overflow-y-auto pr-1 animate-pulse", children: Array.from({ length: 8 }).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "h-9 rounded bg-gray-200 dark:bg-gray-700"
          },
          i
        )) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-2 max-h-96 overflow-y-auto pr-1", children: paths.map((row) => {
      ...
      showRawPayload && samplePayload && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-3 border-t border-gray-200 dark:border-gray-700 space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-2 flex-wrap", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              text: JSON.stringify(
                payloadView === "output" ? applyFieldFilter(
                  samplePayload,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Label,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-xs text-gray-500 dark:text-gray-400 mt-0.5", children: isCreate ? __(
        ...
        useCustomSecret && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: customSecret.length > 0 && customSecret.length < 24 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-amber-600 dark:text-amber-400", children: [
...
const SecretRevealDialog = ({ secret, endpointName, onClose }) => {
  ...
  const [snippetLang, setSnippetLang] = reactExports.useState(
    "php"
  );
  const doCopy = async () => {
    if (!secret) return;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "min-w-full text-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-gray-200 dark:divide-gray-700", children: summary.recent.map((row) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "tr",
          {
      ...
      children: isLoading || !delivery ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Loader2, { className: "h-8 w-8 animate-spin text-gray-400" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3 text-sm", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              label: __("Status", "yatra"),
              raw: /* @__PURE__ */ jsxRuntimeExports.jsx(
                StatusBadge,
                {
...
//# sourceMappingURL=Webhooks-BVWPQrRC.js.map
