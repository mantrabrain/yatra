import { j as jsxRuntimeExports, v as useQueryClient, r as reactExports, u as useQuery, w as useMutation, D as ArrowLeft, O as RefreshCw, ax as Plus, ay as X, at as DollarSign, aA as AlertCircle, as as Clock, s as MapPin, aE as CheckCircle2, aR as Eye, aW as Save } from "./react-vendor-CithbthY.js";
import { u as useToast, g as todayYmd, _ as __, S as SearchableSelect, I as Input, t as toDateValue, a as apiClient } from "./index-Dec_weLB.js";
import { C as Card, f as CardHeader, d as CardContent, P as PageHeader, B as Button, g as CardTitle, S as Select, D as DatePicker, e as Badge, h as CardDescription, T as TimePicker, L as LocationPicker, A as Alert, a8 as useNavigate } from "../../admin/dist/js/app.js";
...
const isPeriod = (e) => typeof e === "object" && e !== null && "start" in e && "end" in e;
const excludedSortKey = (e) => isPeriod(e) ? e.start : e;
const excludedId = (e) => isPeriod(e) ? `${e.start}..${e.end}` : e;
const dayOptions = [
...
const RecurringRuleForm = () => {
  ...
  const [newExcludedStart, setNewExcludedStart] = reactExports.useState("");
  const [newExcludedEnd, setNewExcludedEnd] = reactExports.useState("");
  const [excludedError, setExcludedError] = reactExports.useState("");
  ...
  const sortExcluded = (list) => [...list].sort((a, b) => excludedSortKey(a).localeCompare(excludedSortKey(b)));
  ...
  const addExcludedPeriod = () => {
    ...
    const start = newExcludedStart <= newExcludedEnd ? newExcludedStart : newExcludedEnd;
    const end = newExcludedStart <= newExcludedEnd ? newExcludedEnd : newExcludedStart;
    if (start === end) {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-4 border-t border-gray-200 dark:border-gray-700", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 mt-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-2 mb-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  DatePicker,
                  {
                    value: newExcludedStart,
                    onChange: (value) => setNewExcludedStart(value),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  DatePicker,
                  {
                    ...
                    onChange: (value) => setNewExcludedEnd(value),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 dark:text-gray-400 mb-2", children: __(
                "Both days are included. Every date in between is skipped by this rule.",
                "yatra"
              ) }),
              excludedError && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-red-600 dark:text-red-400 mb-2", children: excludedError }),
              formData.excluded_dates.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: formData.excluded_dates.map((entry) => {
                const id = excludedId(entry);
                const fmt = (d) => (/* @__PURE__ */ new Date(d + "T00:00:00")).toLocaleDateString("en-US", {
                  weekday: "short",
                  month: "short",
                  day: "numeric",
                  year: "numeric"
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Badge,
                  {
                    ...
                    children: [
                      isPeriod(entry) ? `${fmt(entry.start)} → ${fmt(entry.end)}` : fmt(entry),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          type: "button",
...
//# sourceMappingURL=RecurringRuleForm-fKEgpUir.js.map
