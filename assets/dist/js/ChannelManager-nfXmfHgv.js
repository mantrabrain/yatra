import { r as reactExports, u as useQuery, j as jsxRuntimeExports, D as Loader2, N as Network, bV as Link, O as Inbox, ar as Clock, Q as AlertTriangle, A as Activity, aF as Info, Z as Zap, a_ as Globe, by as ShieldCheck, T as TrendingUp, bW as Layers, C as Crown, V as ExternalLink, bq as Settings2, t as useQueryClient, v as useMutation, aw as Plus, aN as Trash2, J as RefreshCw, bX as Power, bY as PowerOff, aD as CheckCircle2, aE as HelpCircle, bh as Send, aV as Save, bt as EyeOff, aQ as Eye, aG as Copy } from "./react-vendor-CqkbFEvK.js";
...
const channelManagerApi = {
  ...
  testConnection: (id) => apiClient.post(`/channel-manager/channels/${id}/test-connection`, {}),
  ...
  testWebhook: (id) => apiClient.post(`/channel-manager/channels/${id}/test-webhook`, {}),
  bulkMappings: (action, ids) => apiClient.post("/channel-manager/mappings/bulk", { action, ids }),
...
function getInitialTab() {
  ...
  if (tab === "mappings" || tab === "bookings" || tab === "logs" || tab === "reconciliation" || tab === "latency") return tab;
  return "channels";
}
...
const UpgradeCard = ({ meta }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "max-w-3xl", children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: __("Channel Manager — Agency plan", "yatra") }),
...
const MappingsSection = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-12 flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Loader2, { className: "h-6 w-6 animate-spin text-gray-400" }) }) : mappings.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-10 text-center", children: [
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "tr",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("code", { className: "rounded bg-gray-100 px-1.5 py-0.5 text-xs dark:bg-gray-800", children: [
                "#",
                m.trip_id
              ] }) }),
...
const MappingEditForm = ({ channels, existing, onClose }) => {
  ...
  const [syncPricing, setSyncPricing] = reactExports.useState(existing.sync_pricing);
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-gray-200 dark:divide-gray-700", children: report.channels.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "tr",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-3 py-2 text-xs", children: [
                c.bookings.pending > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-amber-600 dark:text-amber-400", children: sprintf(__("%d pending", "yatra"), c.bookings.pending) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-400", children: "—" }),
                c.bookings.failed_7d > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-red-600 dark:text-red-400", children: sprintf(__("%d failed (7d)", "yatra"), c.bookings.failed_7d) })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-3 py-2 text-xs", children: [
...
//# sourceMappingURL=ChannelManager-nfXmfHgv.js.map
