import { v as useQueryClient, r as reactExports, u as useQuery, a6 as React, w as useMutation, j as jsxRuntimeExports, D as ArrowLeft, ay as X, y as ChevronDown, aP as Search, aA as AlertCircle, U as Users, ax as Plus, aO as Trash2, bd as ChevronUp, E as Loader2, aW as Save } from "./react-vendor-BJn7BIDO.js";
import { a as apiClient, A as API_ENDPOINTS, f as formatYatraMoney, h as getCurrencySymbol, g as todayYmd, _ as __, I as Input, S as SearchableSelect, l as getCountrySelectOptions, b as apiService, d as formatDateForInput } from "./index-CH-UeeqR.js";
import { u as usePermissions, X as Skeleton, C as Card, f as CardHeader, d as CardContent, P as PageHeader, B as Button, z as ConditionalRender, g as CardTitle, D as DatePicker, S as Select } from "../../admin/dist/js/app.js";
class TaxService {
  constructor() {
  ...
  async loadTaxSettings() {
    try {
      ...
      this.taxSettings = (settings == null ? void 0 : settings.data) ?? settings;
    } catch (error) {
...
const BookingForm = () => {
  ...
  const departureTimesForDate = React.useMemo(() => {
    const rows = (availableDatesData == null ? void 0 : availableDatesData.data) ?? availableDatesData ?? [];
    if (!Array.isArray(rows) || !formData.travel_date) return [];
    const row = rows.find(
      (r) => ((r == null ? void 0 : r.date) ?? (r == null ? void 0 : r.departure_date)) === formData.travel_date
    );
    if (!row) return [];
    const times = Array.isArray(row.departure_times) ? row.departure_times : [row.time ?? row.departure_time ?? ""];
  ...
  const handleTravelersCountChange = (value) => {
  ...
  const saveMutation = useMutation({
    ...
    onError: (error) => {
      ...
      const validationErrors = ((_c2 = (_b2 = (_a2 = error == null ? void 0 : error.response) == null ? void 0 : _a2.data) == null ? void 0 : _b2.data) == null ? void 0 : _c2.validation_errors) || ((_e2 = (_d2 = error == null ? void 0 : error.response) == null ? void 0 : _d2.data) == null ? void 0 : _e2.validation_errors);
      const fieldErrors = {};
      let detail = "";
      ...
      const errorMessage = detail || (error == null ? void 0 : error.message) || __("An error occurred while saving the booking", "yatra");
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-3", children: [
              ...
              departureTimesForDate.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "label",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "select",
                  {
                    ...
                    className: `w-full rounded-md border px-3 py-2 text-sm bg-white dark:bg-gray-800 dark:text-white ${errors.departure_time ? "border-red-500" : "border-gray-300 dark:border-gray-600"}`,
                    required: true,
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: __("Select departure time", "yatra") }),
                      departureTimesForDate.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: t, children: t }, t))
                    ]
                  }
                ),
                errors.departure_time ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-red-500", children: errors.departure_time }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-xs text-gray-500 dark:text-gray-400", children: __(
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  ) : field.type === "country" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                    SearchableSelect,
                    {
                      value: emergencyContactData[field.id] || "",
                      onChange: (v) => handleEmergencyContactChange(field.id, v),
                      options: countrySelectOptions,
                      placeholder: field.placeholder || __("Select Country", "yatra"),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "space-y-3", children: travelersData.map((traveler, travelerIndex) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                expandedTravelers.includes(travelerIndex) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 pt-0 border-t border-gray-100 dark:border-gray-700/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-3 mt-3", children: travelerFields.filter(
                  (field) => (field.applies_to ?? "all") !== "lead" || travelerIndex === 0
                ).map((field) => {
                  var _a2;
                  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        ...
                        field.type === "select" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          ...
                          {
                            value: traveler[field.id] || "",
                            onChange: (v) => handleTravelerChange(
                              travelerIndex,
                              field.id,
                              v
                            ),
...
//# sourceMappingURL=BookingForm-DvQk4uBk.js.map
