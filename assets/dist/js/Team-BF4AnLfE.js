...
import { a as apiClient, _ as __, s as sprintf, c as brandName, u as useToast } from "./index-fqW8jODk.js";
import { O as Skeleton, C as Card, d as CardContent, P as PageHeader, B as Button, f as CardHeader, g as CardTitle, h as CardDescription, S as Select, Q as Table, e as Badge, U as Tooltip, k as ConfirmationDialog, M as Modal, V as Pagination, A as Alert, w as Label, W as Switch, X as setUserCaps, I as Input } from "../../admin/dist/js/app.js";
const teamApi = {
   ...
   */
  clearAuditLog: () => apiClient.delete("/team/audit-log", { data: { confirm: true } }),
  /**
...
const getInitialTab = () => {
  ...
  if (tab === "roles" || tab === "invitations" || tab === "audit" || tab === "settings") return tab;
  return "members";
};
const Team = () => {
  var _a;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    ...
    keepAccessOnDisable ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-md border border-blue-200 bg-blue-50 dark:border-blue-800 dark:bg-blue-950/40 p-4 flex flex-wrap items-start gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold text-blue-900 dark:text-blue-100", children: __("Your team will keep access if you ever turn off this module", "yatra") }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold text-red-900 dark:text-red-100", children: __("Heads up — turning off this module will revoke all team access", "yatra") }),
...
const ExpiryNowHint = ({ expiresLocal }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ConfirmationDialog,
      {
        ...
        cancelText: __("Cancel", "yatra"),
        variant: (pendingBulk == null ? void 0 : pendingBulk.action) === "remove" ? "danger" : "default",
...
const CreateUserModal = ({ onClose }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Modal,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Alert, { variant: "info", title: __("Creates a new WordPress user", "yatra"), children: sprintf(
          /* translators: %s: brand name */
          __(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Modal,
    {
      ...
      children: isLoading || !user ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: [0, 1, 2].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-md border border-gray-200 dark:border-gray-700 p-3 space-y-2", children: [
        ...
        // in-depth check.
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Alert, { variant: "info", title: __("WordPress administrator", "yatra"), children: [
        ...
        !isSelfEdit && !user.is_wp_admin && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-md border border-gray-200 dark:border-gray-700 p-3 space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "member-expires-at", className: "text-sm font-medium", children: __("Access expires on (optional)", "yatra") }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              ...
              type: "datetime-local",
              value: expiresLocal,
              min: unixToLocalInputValue(Math.floor(Date.now() / 1e3) + 60),
              onChange: (e) => {
          ...
          user.is_expired && /* @__PURE__ */ jsxRuntimeExports.jsx(Alert, { variant: "warning", title: __("Access has already expired", "yatra"), children: __(
...
const CapabilityOverridesEditor = ({ registry, effective, grants, revokes, onChangeGrants, onChangeRevokes }) => {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[10px] font-medium px-1.5 py-0.5 rounded ${sensColor(def.sensitivity)}`, children: def.sensitivity })
                ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 flex-shrink-0", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { content: __("Grant this cap on top of the role", "yatra"), children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                    onClick: () => {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { content: __("Deny this cap even if the role allows", "yatra"), children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                    onClick: () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Modal,
    {
      ...
      children: isLoading || !role ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-9 w-full" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: [0, 1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-md border border-gray-200 dark:border-gray-700 p-3 space-y-2", children: [
...
const RoleCreateDrawer = ({ seedSlug, onClose }) => {
  ...
  const [displayName, setDisplayName] = reactExports.useState("");
  const [selectedCaps, setSelectedCaps] = reactExports.useState([]);
  const [appliedTemplateId, setAppliedTemplateId] = reactExports.useState(null);
  React.useEffect(() => {
  ...
  const applyTemplate = (templateId) => {
    ...
    if (!tpl) return;
    const caps = Array.from(/* @__PURE__ */ new Set([...tpl.capabilities, "yatra_access_admin"]));
...
const InvitationsTab = () => {
  ...
  const [pendingRevoke, setPendingRevoke] = reactExports.useState(null);
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-start gap-2 cursor-pointer p-3 rounded-md border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800/40", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-xs text-gray-500 dark:text-gray-400 mt-0.5", children: __("Removes the row from this list. The audit log keeps a permanent trail of who was invited, by whom, and when — that's preserved separately.", "yatra") })
            ] })
          ] }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Modal,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Alert, { variant: "warning", title: __("Treat this link like a password", "yatra"), children: __(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-md border border-green-200 bg-green-50/40 dark:border-green-900 dark:bg-green-950/20 p-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "text-xs text-gray-600 dark:text-gray-400 space-y-1 list-disc pl-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: __("Customers and other users see nothing in the admin.", "yatra") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "text-gray-400 italic", children: __("This setting doesn't apply yet — it kicks in only if you turn the module off.", "yatra") })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "text-xs text-gray-600 dark:text-gray-400 space-y-1 list-disc pl-4", children: [
                ...
                keepAccess ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "text-green-700 dark:text-green-300 font-medium", children: __("Team members keep their access — based on their assigned role.", "yatra") }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: __("Advanced features (expiry, per-user grants, scopes, audit log) pause until you turn the module back on.", "yatra") })
                ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "text-red-700 dark:text-red-300 font-medium", children: __("All Yatra roles are deleted (Owner, Manager, custom roles you built — everything except the Yatra Customer role).", "yatra") }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: __("Re-enabling the module brings back the 8 built-in roles. Custom roles and the original member assignments don't come back automatically.", "yatra") })
                ] })
              ] })
            ]
          }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3 flex-wrap", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 dark:text-gray-400", children: serverAllowlist.trim() === "" ? __("Currently no restriction — every authenticated staff member can sign in from anywhere.", "yatra") : sprintf(
...
//# sourceMappingURL=Team-BF4AnLfE.js.map
