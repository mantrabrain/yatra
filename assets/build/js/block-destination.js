...
/***/ "./assets/src/block-destination/editor.scss":
/*!**************************************************!*\
  !*** ./assets/src/block-destination/editor.scss ***!
  \**************************************************/
...
!function() {
/*!***********************************************!*\
  !*** ./assets/src/block-destination/index.js ***!
  \***********************************************/
__webpack_require__.r(__webpack_exports__);
...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./editor.scss */ "./assets/src/block-destination/editor.scss");
...
const Edit = props => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", blockProps, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)((_wordpress_server_side_render__WEBPACK_IMPORTED_MODULE_5___default()), {
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Destination Settings', 'yatra'),
    initialOpen: true
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Columns', 'yatra'),
    value: attributes.columns,
    options: [{
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Two (2)', 'yatra'),
      value: 2
    }, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Three (3)', 'yatra'),
      value: 3
    }, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Four (4)', 'yatra'),
      value: 4
    }],
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)('yatra/destination', {
  apiVersion: 2,
  title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Destination', 'yatra'),
  description: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('This block is used to show the destination list of Yatra WordPress plugin.', 'yatra'),
  icon: {
    foreground: '#1abc9c',
...
/******/ })()
;
//# sourceMappingURL=block-destination.js.map