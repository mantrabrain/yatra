        ...
        <div class="yatra-listing-container">
            ...
            <div class="yatra-category-header">
                <div class="yatra-category-header-content">
                    ...
                    <p><?php esc_html_e('Browse trips organized by category', 'yatra'); ?></p>
                </div>
                        ...
                        <div class="yatra-category-card">
                            ...
                            <div class="yatra-category-content">
                                ...
                                <?php if (!empty($permalink)) : ?>
                                    <a class="yatra-category-btn" href="<?php echo esc_url($permalink); ?>">
                                        <?php echo esc_html__('Explore Category', 'yatra'); ?>
                                    </a>
                                <?php else : ?>
                                    <button class="yatra-category-btn" type="button">
                                        <?php echo esc_html__('Explore Category', 'yatra'); ?>
                                    </button>
                                <?php endif; ?>
                            </div>
