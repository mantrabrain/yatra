...
<div class="yatra-single-destination" style="max-width: 1200px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div class="destination-trips" style="margin-top: 60px;">
        ...
        <div style="text-align: center;">
            <a href="<?php echo esc_url(add_query_arg(['destination' => urlencode($destination->slug)], home_url('/' . \Yatra\Services\SettingsService::getTripBase() . '/'))); ?>" 
               class="yatra-btn" 
    ...
    <div style="text-align: center; margin-top: 60px; padding-top: 40px; border-top: 1px solid #e5e7eb;">
        <a href="<?php echo esc_url(home_url('/' . \Yatra\Services\SettingsService::getString('destination_base', 'destination') . '/')); ?>" 
