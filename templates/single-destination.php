...
<div class="yatra-single-destination" style="max-width: 1200px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div class="destination-trips" style="margin-top: 60px;">
        ...
        <div style="text-align: center;">
            <a href="<?php echo esc_url(add_query_arg(['destination' => urlencode($destination->slug)], function_exists('yatra_get_trip_listing_url') ? yatra_get_trip_listing_url() : home_url('/' . \Yatra\Services\SettingsService::getTripBase() . '/'))); ?>" 
               class="yatra-btn" 
    ...
    <div style="text-align: center; margin-top: 60px; padding-top: 40px; border-top: 1px solid #e5e7eb;">
        <a href="<?php echo esc_url(function_exists('yatra_get_taxonomy_listing_url') ? yatra_get_taxonomy_listing_url('destination') : home_url('/' . \Yatra\Services\SettingsService::getDestinationBase() . '/')); ?>" 
