 ...
 * Used by the [yatra_booking] shortcode
 * 
 * @package Yatra
 */
...
// Get trip slug from query var or URL parameter
$trip_slug = get_query_var('yatra_booking_trip_slug', '');
...
// Fallback to dummy data if trip not found
if (!$trip_data) {
    $trip_data = (object) [
        'id' => 1,
        'title' => 'Sample Trip',
        'slug' => $trip_slug ?: 'sample-trip',
        'featured_image' => 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?w=1920&q=80',
        'duration_days' => 7,
        'duration_nights' => 6,
...
// Helper function to format price (check if not already defined)
if (!function_exists('yatra_booking_format_price')) {
    function yatra_booking_format_price($price, $currency = 'USD') {
        return $currency . ' ' . number_format($price, 0);
    }
}

$price_per_person = $trip_data->sale_price ?? $trip_data->original_price ?? 0;
$total_price = $price_per_person * $total_travelers;
?>
        ...
        <div class="yatra-booking-main">
            ...
            <form class="yatra-booking-form" id="yatra-booking-form">
                ...
                <div class="yatra-booking-section">
                    <h3 class="yatra-section-title">Contact Information</h3>
                ...
                <div class="yatra-booking-section">
                    <h3 class="yatra-section-title">Traveler Information</h3>
                ...
                <div class="yatra-booking-section">
                    <h3 class="yatra-section-title">Payment Method</h3>
                ...
                <div class="yatra-booking-section">
                    <h3 class="yatra-section-title">Select Payment Gateway</h3>
                ...
                <div class="yatra-booking-actions">
                    <button type="submit" class="yatra-booking-pay-btn">
                        <span>Pay Now</span>
                        <span id="pay-amount"><?php echo yatra_booking_format_price($total_price, $trip_data->currency ?? 'USD'); ?></span>
                    </button>
            ...
            <div class="yatra-booking-summary">
                ...
                <div class="yatra-summary-travel-details">
                    <div class="yatra-summary-form-group">
                        ...
                        <input type="date" id="travel-date" name="travel_date" value="<?php echo esc_attr($booking_date); ?>" form="yatra-booking-form" required>
                    </div>
                    ...
                    <div class="yatra-summary-form-group">
                        ...
                        <div class="yatra-traveler-selector">
                            ...
                            <input type="number" id="number-of-travelers" name="number_of_travelers" value="<?php echo esc_attr($total_travelers); ?>" min="<?php echo esc_attr($trip_data->min_travelers ?? 1); ?>" max="<?php echo esc_attr($trip_data->max_travelers ?? 20); ?>" readonly form="yatra-booking-form">
                ...
                <div class="yatra-summary-trip">
                    <div class="yatra-summary-image">
                        <img src="<?php echo esc_url($trip_data->featured_image ?? 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?w=400'); ?>" alt="<?php echo esc_attr($trip_data->title ?? 'Trip'); ?>">
                    </div>
                    <div class="yatra-summary-details">
                        <h4><?php echo esc_html($trip_data->title ?? 'Trip'); ?></h4>
                        <div class="yatra-summary-meta">
                            <span><?php echo esc_html($trip_data->duration_days ?? 7); ?> Days</span>
                            <span>•</span>
                            <span><?php echo esc_html(ucfirst($trip_data->difficulty_level ?? 'moderate')); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="yatra-summary-pricing">
                    <div class="yatra-price-row">
                        ...
                        <span><?php echo yatra_booking_format_price($price_per_person, $trip_data->currency ?? 'USD'); ?></span>
                    </div>
                    <div class="yatra-price-row">
                    ...
                    <div class="yatra-price-row yatra-price-total">
                        ...
                        <span id="summary-total"><strong><?php echo yatra_booking_format_price($total_price, $trip_data->currency ?? 'USD'); ?></strong></span>
                    </div>
                </div>
...
<script>
// Initialize booking form if yatraBookingInit exists
if (typeof yatraBookingInit === 'function') {
    yatraBookingInit();
}
</script>
