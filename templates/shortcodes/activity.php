...
<div class="yatra-activity-shortcode" data-atts='<?php echo esc_attr(json_encode($atts)); ?>'>
    <div class="yatra-activity-header">
        ...
        <?php if (!empty($activities)): ?>
            <div class="yatra-activity-count">
                <?php 
                printf(
                    _nx('%d Activity', '%d Activities', count($activities), 'activity count', 'yatra'),
                    esc_html(count($activities))
                );
                ?>
            </div>
        <?php endif; ?>
                                ...
                                <div class="yatra-category-card-stats">
                                    ...
                                    <?php if (!empty($activity['min_price'])): ?>
                                        <div class="category-stat price">
                                            ...
                                            <span class="category-stat-value">
                                                <?php esc_html_e('From', 'yatra'); ?> <?php echo esc_html(yatra_get_currency_symbol(get_option('yatra_currency', 'USD')) . number_format($activity['min_price'], 2)); ?>
                                            </span>
                                        </div>
                                    <?php endif; ?>
                                </div>
    ...
    <?php else: ?>
        ...
        <div class="yatra-activity-empty">
            ...
            <p><?php esc_html_e('We couldn\'t find any activities. Please check back later or browse our tours directly.', 'yatra'); ?></p>
